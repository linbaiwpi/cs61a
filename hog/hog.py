...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for i in range(num_rolls):
        ...
        if curr_res == 1:
            ...
            dice_sum = dice_sum + curr_res
        #print("choose curr_res = " + str(curr_res) + ", dice_sum = " + str(dice_sum))
    if sow_sad_flag:
        dice_sum = 1
    return dice_sum
    # END PROBLEM 1
...
def tail_points(opponent_score):
    ...
    return 2*abs(ones_digit-tens_digit)+1
    # END PROBLEM 2
...
def play(strategy0, strategy1, update,
    ...
    while (1):
        ...
        if score0 >= goal:
            break
        #print(f"End 0 score " + str(score0) + " , " + str(score1))
        num_rolls = strategy1(score1, score0)
        score1 = update(num_rolls, score1, score0, dice)
        if score1 >= goal:
            break
    #print(f"end score " + str(score0) + " , " + str(score1) + " , " + str(goal))
    # END PROBLEM 5
...
def make_averaged(original_function, total_samples=1000):
    ...
    def func(*args):
        ...
        for i in range(total_samples):
            ...
            accum_sum = accum_sum + res
            #print("********************" + str(res))
        return accum_sum / total_samples
    return func
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    for i in range(1, 11):
        #print("=================" + str(i))
        curr_score = averaged_dice(i, dice)
        #print("curr_score: " + str(curr_score))
        if (curr_score > max_score):
            best_num_rolls = i
            max_score = curr_score
        #print("max_score: " + str(max_score))
        #print("best_num_rolls: " + str(best_num_rolls))
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    score_exp = tail_points(opponent_score)
